...
<body>
    ...
    function chagne(object,event){
        if(object.name == "available[]"){
            alert("그 좌석은 예매가 가능한 좌석입니다.\n 예매하기 페이지를 통해 예매해주세요!\n");
        }
	...
	function change2(object, event){

        if(object.style.background == "blue"){
    ...
    <div>
    <form action="reserve2.jsp" method="post" name="textform" onsubmit="return reserve();">
    ...
    <tbody id='seat'>
        ...
        <tr>
            ...
            <td><input type="button" value="L16" onclick="change(this)" name="available[]" class="L16" style="background-color: white;"></td>
						<td><input type="hidden" id="str" name="str" value=""></td>
        </tr>
        ...
        <div id='print' align="center" style="height:30px;"> O : 예매 취소 가능 (본인이 예매한 좌석) </div>
        <div align="center" style="height:30px; "> X : 예매 취소 불가능 (이미 예약된 좌석)</div>

        <div align="center"> <input type="submit" value="예매하기"></div>
     ...
     <% Connection conn;
          ...
          try
          {
              ...
              stmt = conn.createStatement();
                ...
                while(rs.next()){
                    if(rs.getString("movie").equals("허삼관") && rs.getString("start_time").equals("08:00")){
