...
<%
	...
	String tt = request.getParameter("cnt");
	int cnt = Integer.parseInt(tt);
...
<body>
    ...
    <div>
    <form action="reservation2.jsp" method="post" name="textform" onsubmit="return reserve();">
    ...
    <tbody id='seat'>
        ...
        <div id='print' align="center" style="height:50px;"> 선택한 좌석 : </div>
