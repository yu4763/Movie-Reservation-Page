...
<body>
    ...
    function addtable(img,title,start_time,end_time,Auditorium,seat){
        ...
        formtag.action="reservation.jsp";
        formtag.method="post";
        formtag.setAttribute('onsubmit','return checklogin()');
    ...
    function checklogin(){
      alert("로그인이 필요한 기능입니다. 로그인 페이지로 넘어갑니다.");
...
<div >
   <table id='my-table' align="center" border ="1px solid black" style="font-size:1.3em; " >
		 	<br>
      <caption> <strong>[영화 예매하기]<br> <br></strong> </caption>
